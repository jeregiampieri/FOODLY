...
export const Layout = ({children}) => {
    ...
    // hago uso del useEffect, con dependencia en el pathname para que cada vez que el usuario navegue dentro de la aplicación y
    // se haga un cambio de path, la aplicación traslada al usuario al comienzo de la web
    useEffect(() => {
        window.scrollTo(0,0);
    }, [pathname])
